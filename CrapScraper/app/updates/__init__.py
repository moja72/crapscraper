...
from app.updates.plugintheme_source_recovery import install_plugintheme_source_recovery
from app.updates.source_filter_runtime import install_update_source_filters

install_ultrapack_fast_probe()
install_fast_transaction()
install_update_performance_runtime()
install_plugintheme_source_recovery()
install_update_source_filters()
