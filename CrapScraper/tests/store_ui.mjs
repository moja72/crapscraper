...
let enabled=false,toggleCalls=0,qualityCalls=0;
...
const pricing={ok:true,write_enabled:true,individual:{total:2,items:[{product_id:101,product_name:"Elementor Demo",kind:"plugin",variation_id:1011,period:"annual",regular_price:"99.00",sale_price:"79.00"},{product_id:101,product_name:"Elementor Demo",kind:"plugin",variation_id:1012,period:"lifetime",regular_price:"199.00",sale_price:"149.00"}]},packs:{items:[{product_id:200,product_name:"Pack Demo",product_type:"simple",price_group:"pack",regular_price:"299.00",sale_price:"249.00",variations:[]}]},plans:{items:[{product_id:300,product_name:"Plano Demo",product_type:"simple",price_group:"plan",regular_price:"399.00",sale_price:"349.00",variations:[]}]}};
...
try{
  ...
  await page.goto(`http://127.0.0.1:${port}/`,{waitUntil:"networkidle"});await page.click('[data-tab="store"]');await page.waitForSelector('#store-quality tr[data-store-select]');
  ...
  console.log(JSON.stringify({ok:true,order:true,monitor:true,persistentToggle:true,pricingAccordions:true,quality:true,categories:true,stablePolling:true,responsive:true,qualityCalls}));
