...
try{
  ...
  for(const [tab,selector] of Object.entries({compare:'#comparison-page-size',add:'#add-page-size'})){if(await page.locator(selector).inputValue()!=="5")throw new Error(`${tab} não inicia com 5 itens`)}
