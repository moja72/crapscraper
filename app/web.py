...
>
  ...
  <div class="card updates-card-section updates-queue-section">
    ...
    <details class="card updates-card-section updates-section updates-history-accordion" id="updates_history_accordion">
      ...
      <div class="operational-history-tabs" role="tablist" aria-label="Tipo de histórico"><button class="operational-history-tab is-active" id="updates_history_completed" data-history-tab="completed" role="tab" aria-selected="true" type="button"><span class="operational-history-tab-label">Concluídos</span> (<span class="operational-history-tab-count" id="updates_history_completed_count">0</span>)</button><button class="operational-history-tab" id="updates_history_errors" data-history-tab="errors" role="tab" aria-selected="false" type="button"><span class="operational-history-tab-label">Erros</span> (<span class="operational-history-tab-count" id="updates_history_errors_count">0</span>)</button></div>
