...
_SCRIPT_PATH = Path(__file__).resolve().parent / "static" / "addition_processes_bridge.js"
...
def _patched_render_panel_page(*args: Any, **kwargs: Any) -> str:
    ...
    try:
        ...
        return html
    block = f"\n<script data-addition-processes-bridge>\n{script}\n</script>\n"
    return html.replace("</body>", block + "</body>", 1) if "</body>" in html else html + block


def install_addition_processes_bridge_policy() -> None:
