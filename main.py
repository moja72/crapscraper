...
# Adições: reduz a operação a um único botão e encadeia o fluxo automático com logs ao vivo.
...
# Adições: usa perfil isolado da conta Coproducaolancamentos e o projeto CS Automação.
...
# Adições: mantém os prompts visuais específicos de plugin/tema e as referências locais.
